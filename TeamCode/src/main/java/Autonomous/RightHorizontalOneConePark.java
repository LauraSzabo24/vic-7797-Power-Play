...
@Autonomous
public class RightHorizontalOneConePark extends LinearOpMode {
...
//
    ...
    public void runOpMode() {
       ...
       // waitForStart();
        ...
        while ( opModeInInit() /*opModeIsActive() && !(tagNumber == 1) && !(tagNumber == 2) && !(tagNumber == 3) && !(tagNumber == 4) && !(tagNumber == 5)*/) {
