...
//
    ...
    public void runOpMode() {
        ...
        Pose2d farmPose = new Pose2d(fPx,fPy,Math.toRadians(50));
        Pose2d stackPose = new Pose2d(sPx,sPy,Math.toRadians(180));


        Pose2d middlePark = new Pose2d(-35.8,-33.6,Math.toRadians(90));
        Pose2d leftPark =  new Pose2d(-60.8,-33.6,Math.toRadians(90));
        Pose2d rightPark =  new Pose2d(-10.8,-33.6,Math.toRadians(90));
            ...
            switch (currentState) {
                ...
                case TO_STACK:
                    if (!drive.isBusy()) {
                        //fPy = fPy + 12;
                        //fPx = fPx + 10;
                        farmPose.plus(new Pose2d(1,1,Math.toRadians(1)));//.plus adds the exact amount of units shown- to farmPose, hopefully it works
